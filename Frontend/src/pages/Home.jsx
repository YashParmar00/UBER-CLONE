...
const Home = () => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <img className='w-16 absolute left-5 top-14' src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png" alt="" />
            <div className='h-screen w-screen absolute top-0 left-0 z-0'>
                <LiveTracking />
            </div>

            {/* Main content over the map */}
            <div className=' flex flex-col justify-end h-screen absolute top-0 w-full z-10 pointer-events-none'>
                <div className='h-[32%] p-6 bg-white relative pointer-events-auto'>
